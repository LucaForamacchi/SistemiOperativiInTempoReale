...
int main(int argc, char *argv[]) 
{
	...
	//univoca), la quantità di vaccini nel lotto di cui dispone e la quantità minima di richieste necessaria 
	//ad iniziare la distribuzione
	if (argc < 4) { 
